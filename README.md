FUTURiDE is a Java web app, which emulates a car dealership website. Uses Spring Boot to run, Thymeleaf for frontend integration, and Spring Security for user oauth.
